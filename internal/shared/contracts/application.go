...
type NotificationService interface {
	...
	SendWebhook(ctx context.Context, url string, payload []byte, headers map[string]string) error
	
	// SendSlack sends a Slack notification
	SendSlack(ctx context.Context, webhook string, message string) error
	
	// SendTeams sends a Microsoft Teams notification
	SendTeams(ctx context.Context, webhook string, message string) error

...
var apiTokenTracer = otel.Tracer("promptshield/postgres/api_tokens")
...
func (r *pgAPITokenRepo) Create(ctx context.Context, token *domain.APIToken) error {
	ctx, span := tracing.TraceDatabaseQuery(apiTokenTracer, ctx, "INSERT", "api_tokens")
	defer span.End()
...
func (r *pgAPITokenRepo) Get(ctx context.Context, id uuid.UUID) (*domain.APIToken, error) {
	ctx, span := tracing.TraceDatabaseQuery(apiTokenTracer, ctx, "SELECT", "api_tokens")
	defer span.End()
...
func (r *pgAPITokenRepo) UpdateLastUsed(ctx context.Context, id uuid.UUID) error {
	ctx, span := tracing.TraceDatabaseQuery(apiTokenTracer, ctx, "UPDATE", "api_tokens")
	defer span.End()
...
func (r *pgAPITokenRepo) Delete(ctx context.Context, id uuid.UUID) error {
	ctx, span := tracing.TraceDatabaseQuery(apiTokenTracer, ctx, "DELETE", "api_tokens")
	defer span.End()

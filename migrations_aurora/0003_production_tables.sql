-- Production tables: users/auth, billing, ops, config, admin
...
CREATE INDEX IF NOT EXISTS idx_usage_metrics_tenant_period ON usage_metrics(tenant_id, period_start DESC);
CREATE INDEX IF NOT EXISTS idx_violations_tenant_created ON violations(tenant_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_feature_flags_tenant_flag ON feature_flags(tenant_id, flag_name);
